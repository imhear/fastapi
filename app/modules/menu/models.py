"""
系统菜单模型
app/modules/menu/models.py
"""
from sqlalchemy import Column, String, SmallInteger, BigInteger, ForeignKey
from sqlalchemy.orm import relationship
from app.core.database import BaseTableModel


class Menu(BaseTableModel):
    __tablename__ = 'sys_menu'
    __table_args__ = {'comment': '系统菜单表'}

    parent_id = Column(BigInteger, ForeignKey('sys_menu.id'), nullable=True,default=None,comment='父菜单ID（NULL表示顶级菜单）')
